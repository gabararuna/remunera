...
const defaultParams: SalaryParams = {
  ...
  mes_aumento: new Date(new Date().getFullYear(), 9, 1), // outubro do ano vigente

  salario_bruto: 8356.82,
  tem_adiantamento: false,
  valor_adiantamento: 2507.05,   // 0.3 × 8356.82
  dia_adiantamento: 15,
  plr_bruto: 16713.64,           // 2 × 8356.82
  data_plr: new Date(new Date().getFullYear(), 3, 15),
  ticket_mensal: 1510.51,
  ticket_anual: 1943.90,
